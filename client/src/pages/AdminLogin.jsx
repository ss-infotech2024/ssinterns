...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Vite proxy → /api/admin/login → https://ssinternsbackend.onrender.com/api/admin/login
      const res = await fetch("https://ssinternsbackend.onrender.com/api/admin/login", {
        method: "POST",
        headers: {
